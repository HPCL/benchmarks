...
declare -a _metrics=( \
                   ...
                   "skx_unc_imc0::UNC_M_CAS_COUNT:RD:cpu=24" \
                   "skx_unc_imc1::UNC_M_CAS_COUNT:RD:cpu=24" \
                   "skx_unc_imc2::UNC_M_CAS_COUNT:RD:cpu=24" \
                   "skx_unc_imc3::UNC_M_CAS_COUNT:RD:cpu=24" \
                   "skx_unc_imc4::UNC_M_CAS_COUNT:RD:cpu=24" \
                   "skx_unc_imc5::UNC_M_CAS_COUNT:RD:cpu=24" \

                   "skx_unc_imc0::UNC_M_CAS_COUNT:WR:cpu=24" \
                   "skx_unc_imc1::UNC_M_CAS_COUNT:WR:cpu=24" \
                   "skx_unc_imc2::UNC_M_CAS_COUNT:WR:cpu=24" \
                   "skx_unc_imc3::UNC_M_CAS_COUNT:WR:cpu=24" \
                   "skx_unc_imc4::UNC_M_CAS_COUNT:WR:cpu=24" \
                   "skx_unc_imc5::UNC_M_CAS_COUNT:WR:cpu=24" \
                   )
...
out_dir=cali_mm_default_icc_simd
