...
void multiply_matrix_v(double** mat_a, int rows_a, int cols_a, double** mat_b, int cols_b, double** mat_c);
void multiply_matrix_vp(double** mat_a, int rows_a, int cols_a, double** mat_b, int cols_b, double** mat_c);
// same but with parallelism potentially
// calls the recursive strassen alg
